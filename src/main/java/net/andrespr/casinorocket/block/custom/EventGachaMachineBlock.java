...
public class EventGachaMachineBlock extends Block {
    ...
    public static final MapCodec<EventGachaMachineBlock> CODEC = createCodec(EventGachaMachineBlock::new);
    ...
    public EventGachaMachineBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos,
        ...
        if (!stack.isOf(ModItems.EVENT_COIN)) {
            player.sendMessage(Text.literal("This machine only accepts Event Coins!").formatted(Formatting.RED), true);
        ...
        if (!hasItems && !hasPokemon) {
            player.sendMessage(Text.literal("There's no event at the moment.").formatted(Formatting.RED), true);
            return ActionResult.FAIL;
        }
