...
import net.andrespr.casinorocket.games.blackjack.BlackjackUtils;
...
public final class BlackjackCommands {

    private BlackjackCommands() {}

    public static LiteralArgumentBuilder<ServerCommandSource> buildSubcommand() {
        return CommandManager.literal("blackjack")
    ...
    private static int executeLeaderboard(CommandContext<ServerCommandSource> context, String key) {
        ...
        Text msg = BlackjackUtils.getLeaderboardText(context.getSource().getServer(), key);
